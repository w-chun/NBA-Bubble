...
(function () {
  ...
  var forceXReset = d3.forceX(window.screen.width / 2).strength(0.1);
  ...
  d3.queue().defer(d3.csv, "https://w-chun.github.io/NBA-Bubble/data/warriorsFG_2016_2017.csv").await(ready);
  ...
  function ready(error, datapoints) {
    ...
    var teams = d3.nest().key(function () {
      return "Team";
    }).rollup(function () {
    ...
    var playerInfo = d3.select("#bubble").append("div").style("visibility", "hidden").style("position", "absolute").style("background-color", "rgba(103, 58, 183, 0.7)").style("padding", "10px").style("border-radius", "5px").style("font", "14px sans-serif").style("color", "white");
    ...
    d3.select("#percent").on('click', function () {
      simulation.force("x", forceXSeparate).force("y", forceY).alphaTarget(0.10).restart();
    ...
    d3.select("#reset").on('click', function () {
      simulation.force("x", forceXReset).force("y", forceY).alphaTarget(0.10).restart();
      playerInfo.style("visibility", "hidden");
      percentages.style("visibility", "hidden");
    });
