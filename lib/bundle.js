...
(function () {
  ...
  function ready(error, datapoints) {
    ...
    var playerInfo = d3.select("#bubble").append("div").style("visibility", "hidden").style("position", "absolute").style("background-color", "rgba(29, 66, 138, 0.7)").style("padding", "10px 20px").style("border-radius", "5px").style("font", "14px sans-serif").style("color", "white");
