...
(function () {
  ...
  var svg = d3.select("#bubble").append("svg").attr("class", "svg").attr("preserveAspectRatio", "xMinYMin meet").attr("preserveAspectRatio", "xMaxYMax meet").attr("viewBox", "0 0 100% 100%").classed("svg-content", true).append("g").attr("transform", "translate(0,0)");
