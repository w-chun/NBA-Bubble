...
(function () {
  ...
  var forceXReset = d3.forceX(window.screen.width / 2).strength(0.08);
  ...
  d3.queue().defer(d3.csv, "https://w-chun.github.io/NBA-Bubble/data/lakersFG_2016_2017.csv").await(ready);
